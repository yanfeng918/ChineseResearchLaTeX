...
\newcommand{\NSFCProjectReferenceHeading}{\color{black} \sihao \templatefont \bfseries \leftline{参考文献}}
...
% 本项目正文中的 1.1、1.2 等二级标题按要求使用黑色。
\newcommand{\NSFCProjectSubsubsectionFormat}{\color{black} \subsubsectionzihao \templatefont \bfseries}
